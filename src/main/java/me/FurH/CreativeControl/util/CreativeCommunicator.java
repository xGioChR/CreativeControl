...
public class CreativeCommunicator {
     ...
     */
    public void error(Thread thread, Throwable ex, String message, Object...objects) {
        error(thread.getStackTrace()[1].getClassName(), thread.getStackTrace()[1].getLineNumber(), thread.getStackTrace()[1].getMethodName(), ex, message, objects);
    }
